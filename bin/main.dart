...
class ApacheTest {
  ...
  // SERVER superglobal
  final Map Server = {
    'SELF': '<TMPL_VAR name = "server_self">',
  ...
  final Map Get = {};//'stam':'290597', 'date':'20150704', 'View': 'month'};
  final Map Post = {};
  final Map Cookie = {};
  ...
  void dumpEnvironment() {
    ...
    writeOutput(
        '<h3> HTTP_ACCEPT_CHARSET : ${Server["HTTP_ACCEPT_CHARSET"]}  </h3>');
    writeOutput(
        '<h3> HTTP_ACCEPT_ENCODING : ${Server["HTTP_ACCEPT_ENCODING"]}  </h3>');
    writeOutput(
        '<h3> HTTP_ACCEPT_LANGUAGE : ${Server["HTTP_ACCEPT_LANGUAGE"]}  </h3>');
